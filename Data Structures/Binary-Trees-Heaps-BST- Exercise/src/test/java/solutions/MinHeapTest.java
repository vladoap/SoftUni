...
public class MinHeapTest {
    ...
    @Test
    public void testHeapifyDownRemoveOne() {
        Heap<Product> heap = new MinHeap<>();
        heap.add(new Product(13));
        Product element = heap.poll();
        assertEquals(element, new Product(13));
    ...
    @Test
    public void testHeapifyDownRemoveMany() {
        Product result = minHeap.poll();
        assertEquals(result, new Product(5));
