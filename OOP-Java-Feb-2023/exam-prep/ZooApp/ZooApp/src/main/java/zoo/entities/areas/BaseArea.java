...
public abstract class BaseArea implements Area {
    ...
    public String getInfo()  {
        ...
        String animalsNames = animals.isEmpty()
                ? "none"
                : String.join(" ", animals.stream().map(Animal::getName).collect(Collectors.toCollection(ArrayList::new)));

        sb.append(String.format("%s (%s):", name, getClass().getSimpleName())).append(System.lineSeparator())
                .append(String.format("Animals: %s", animalsNames)).append(System.lineSeparator())
